...
interface ClientProps {
  initialPending: BottleneckReport[]
  initialReviewed: BottleneckReport[]
}
...
export function DelayReportsClient({ initialPending, initialReviewed }: ClientProps) {
  const [activeTab, setActiveTab] = useState<Tab>('pending')
  const [pending, setPending] = useState<BottleneckReport[]>(initialPending)
  const [reviewed, setReviewed] = useState<BottleneckReport[]>(initialReviewed)
