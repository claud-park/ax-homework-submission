...
const MOBILE_TABS: BottomTab[] = [
  ...
  { icon: LayoutList, label: '마일스톤 현황', href: '/my-project/milestones' },
  { icon: Calendar,   label: '1-on-1 세션',   href: '/my-project/sessions' },
  { icon: Video,      label: '1-on-1 신청',   href: '/my-project/one-on-one' },
]
