...
> **실제 커밋 날짜 기반 산정** — 날짜당 1 MD로 계산

---

### 11.1 완료 구간 (2026-05-14 ~ 2026-05-21) · 실적 5 MD

| WBS # | 날짜 | 주요 작업 | 공수 (MD) | 상태 |
|---|---|---|:---:|---|
| 1.0 | 05/14 | **설계 Day 1** — 과제 제출 플로우 스펙, DB 초기 설계, Supabase·Google OAuth 환경 구성 | 1 | ✅ |
| 2.0 | 05/15 | **설계 Day 2** — Charter 리뷰 스펙, 데이터 모델 확장 (charter_submissions, milestones, deadline_change_requests) | 1 | ✅ |
| 3.0 | 05/18 | **구현 Day 1** — MVP 전체: 과제 CRUD, Charter WYSIWYG(6섹션)·DOCX, Milestone/Gantt, 파일 제출·Storage, 칸반 DnD, 이메일 7트리거, 양방향 댓글, shadcn/ui 통일 | 1 | ✅ |
| 4.0 | 05/19 | **CI Day** — GitHub Actions (Bun: lint·typecheck·build), 배포 계획 문서 | 1 | ✅ |
| 5.0 | 05/21 | **구현 Day 2** — Bun 마이그레이션, Docker·Jenkins CD, 임시저장(Draft/Publish) 전체, PRD 문서화 | 1 | ✅ |
| **완료 소계** | | | **5 MD** | |

---

### 11.2 예정 구간 (2026-05-22 이후) · 동일 속도 기준

| WBS # | 단계 | 주요 작업 | 공수 (MD) | 예정 기간 | 우선순위 |
|---|---|---|:---:|---|---|
| 6.0 | **P0 — 안정화** | 판정 취소 API, 이메일 에러 핸들링, CSS 변수 통일 | 0.5 | 3일 | 🔴 긴급 |
| 7.0 | **P1 — 대시보드** | 챔피언 `/progress`, 어드민 `/admin/progress`, 주간 리포트 | 1 | 1주 | 🟠 높음 |
| 8.0 | **P2 — 운영 확장** | 어드민 다중화, SendGrid/SES 마이그레이션 | 1 | 1주 | 🟡 보통 |
| 9.0 | **P3 — 분석** | 성과 분석 대시보드, In-app 알림 센터 | 2 | 2주 | 🟢 낮음 |
| 10.0 | **P4 — 화이트라벨** | 멀티-테넌트 기반 구조, 타 프로그램 온보딩 | TBD | TBD | 📋 검토 |
| **예정 소계** | | | **4.5 MD** | | |
